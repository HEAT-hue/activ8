      ...
      <div>
        <div className="w-full border-b-[1.5px] border-b-[#eaecf0] mb-4">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-y-6 sm:gap-y-0 sm:items-center mb-4">
            ...
            <p className="sm:bloc flex font-bold justify-center items-center gap-x-2">
              <span className="text-xl sm:text-4xl text-[#956F3E]">{price}</span>
              <span className="text-sm self-center sm:text-base font-normal text-[#48361E] ml-1">monthly</span>
            </p>
          </div>
        </div>
...
const Plans = () => {
  ...
  return (
    <section className="p-4 pt-14 pb-10 bg-[#F9F9F9]">
      <div className="container mx-auto">
        <h1 className="text-4xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-10">
          Find the Right Plan for <span className="text-[#906C3C]">YOU</span>
        </h1>
        <div className="w-full flex justify-center items-center">
          <p className="text-center mb-8 px-2 text-sm sm:text-base w-full sm:w-[50%]">
            “Choose your path to perks” subscribe for either packages or pay for individual services at a discounted price.
          </p>
        </div>
