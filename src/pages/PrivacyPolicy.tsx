...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = 'Activ8 - Privacy Policy';
  }, []);
  return (
    <>
      ...
      >
        <div className="w-full sm:w-[70%] md:w-[80%] lg:w-[60%]  mx-auto text-center">
          ...
          <p className="mt-8 w-[98%] sm:w-full text-sm leading-5 text-gray-600 max-w-2xl mx-auto">
            Your privacy is important to us at Activ8. We respect your privacy regarding any information we may collect from you across our website and app.
          </p>
        </div>
      </section>
      <div className="px-4 md:px-24 py-8 bg-gray-100">
        <div className="max-w-4xl mx-auto p-6 ">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4 text-gray-900">What are your privacy rights?</h2>
            <p className="text-[#475467]">
              Phasellus euismod neque ut neque varius, sit amet commodo libero vestibulum. Curabitur at quam a dolor dapibus fermentum.
            </p>
          </section>
